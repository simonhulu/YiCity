...
//    self.window.rootViewController = nav ;
    ...
    YCWebViewController *publish = [[YCWebViewController alloc]initWithAddress:@"http://demo.yicity.com/ad/chooseCategory.html"];
    ...
    YCWebViewController *userProfile = [[YCWebViewController alloc]initWithAddress:@"http://demo.yicity.com/app/me.html"];
    ...
    YCWebViewController *more = [[YCWebViewController alloc]initWithAddress:@"http://demo.yicity.com/app/more.html"];
